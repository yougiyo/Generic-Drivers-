...
The drivers were developed and tested specifically on the **NUCLEO-F401RE** development board, which uses the **STM32F401RE** microcontroller with an **ARM Cortex-M4** core.
